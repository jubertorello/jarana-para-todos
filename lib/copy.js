export const COPY = {
  es: {
    ...
    merch: [
      { k: "cascos", t: "Cascos", d: "Pintados a mano, uno a uno. Verde Jarana y la frase en el lateral." },
      { k: "camisetas", t: "Camisetas", d: "Próximamente." },
      { k: "carnet", t: "Carnet jaranero", d: "Tu acreditación oficial. Personalizada, con foto y alias." },
      { k: "cromos", t: "Cromos", d: "La colección de personajes. Cada jaranero tiene el suyo." }
    ],
  ...
  en: {
    ...
    merch: [
      { k: "cascos", t: "Helmets", d: "Hand painted, one by one. Jarana green with the phrase on the side." },
      { k: "camisetas", t: "T-shirts", d: "Coming soon." },
      { k: "carnet", t: "Jaranero card", d: "Your official pass. Personalised, with photo and nickname." },
      { k: "cromos", t: "Trading cards", d: "The character collection. Every jaranero has one." }
    ],
...
// Imagenes del merchandising. Pendientes de subir a Cloudinary: mientras
// valgan null, la celda muestra el nombre de la pieza en su lugar.
export const MERCH_IMG = {
  cascos: null,
  camisetas: null,
  carnet: null,
  cromos: null
