export const COPY = {
  es: {
    ...
    merchSee: "Ver más",
    igLabel: "Ahora mismo",
    igSync: "Cada Jarana se anuncia aquí primero. Síguenos para no perderte la próxima.",
    igFollow: "Seguir",
  ...
  en: {
    ...
    merchSee: "See more",
    igLabel: "Right now",
    igSync: "Every Jarana is announced here first. Follow us so you don't miss the next one.",
    igFollow: "Follow",
